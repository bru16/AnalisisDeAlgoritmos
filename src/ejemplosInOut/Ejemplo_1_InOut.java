 ...
 * caracteristicas particulares, para generar conjuntos de valores random.
 */
public class Ejemplo_1_InOut {
	...
	public static void main(String[] args) {
		...
		String nombreArchivoSalida = "src/ejemplosInOut/salida";
