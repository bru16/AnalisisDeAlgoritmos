...
/**
 * Este otro ejemplo esta para mostrar como generar 10000 valores enteros,
 * menores a 1,000,000 de forma aleatoria, y los guardar en un archivo, de a uno
 * por linea.
 *
 * https://docs.oracle.com/javase/7/docs/api/java/util/Random.html
 *
 * Otro enfoque es usar math.random() que les devuelve un double entre 0 y 1, y
 * luego "desnormalizar" los datos hacia el rango que les interese. Ejemplo para
 * generar doubles entre 5 y 10. int techo = 10; int piso = 5; double aleatorio
 * = piso + (Math.random() * (techo - piso));
 *
 */
public class Ejemplo_2_randomInts {
	...
	private static int[] leerArchivo() {
		...
		try {
			...
			for (int i = 0; i < CANTNUMEROS; i++) {
				// De cada linea debemos obtener la informacion que nos sirva, numeros, palabras
				// aisladas...etc
	...
	public static void main(String[] args) {
		/**
		 * Como nos interesa medir la eficiencia de nuestros algoritmos, realizaremos
		 * mediciones de eficiencia de los metodos que nos interese, partiendo del
		 * supuesto de que tenemos datos cargados en memoria, para suprimir el sesgo que
		 * nos traeria la E/S (por más que sea lineal, involucra operaciones muy
		 * lentas, y que varian muchisimo de un sistema a otro.
		 *
		 * Podemos ver como varia el tiempo de ejecución nuestro algoritmo en función
